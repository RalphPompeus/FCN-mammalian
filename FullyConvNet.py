...
from  tkinter import * #I changed the modeule from Tkinter to tkinter!!!!!!
...
class FullyConvNet:
    ...
    def defineModel(self,kernel_size=3):
            ...
            #filterDepthsIn = [4,8,16] #first run
            
            #filterDepthsIn = [8,16,32] #second run
            
            filterDepthsIn = [16,32,64] #final run
    ...
    def predict(self,images,threshold=False,thresh=0.1):
        predictions = []
        for image in images:
            start = time.time()
